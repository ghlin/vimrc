...
hi CursorColumn gui=italic                                             guibg=bg
hi CursorLine   gui=none                                               guibg=#dddddd
hi CursorLineNr gui=none                      guifg=Black              guibg=bg
...
hi LineNr                                     guifg=Gray               guibg=bg

hi clear MatchParen

hi MatchParen   gui=underline,italic,bold     guifg=DarkBlue
hi ModeMsg      gui=none                      guifg=#002500
...
hi PmenuSel     gui=none                      guifg=White              guibg=Black
hi Question                                   guifg=DarkRed
hi Search       gui=underline                 guifg=White              guibg=DarkBlue
hi SpecialKey   gui=none                      guifg=Gray
...
hi Keyword      gui=none             guifg=#0000bb
