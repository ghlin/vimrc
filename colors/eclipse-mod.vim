...
let g:colors_name = "eclipse-mod"

highlight Normal gui=none guifg=#000000 guibg=#f5f5f7 ctermfg=Gray
...
highlight VertSplit    gui=none guifg=#904838 guibg=bg      ctermfg=darkgrey cterm=none       ctermbg=blue
...
" Cursor
highlight Cursor   gui=none guifg=#000000 guibg=#0080f0
...
" TabLine
highlight TabLine     gui=none guifg=bg
highlight TabLineFill          guifg=White
highlight TabLineSel  gui=none guifg=Black
